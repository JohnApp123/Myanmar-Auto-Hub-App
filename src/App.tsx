  ...
  const handleSaveCar = (carData: Partial<Car>) => {
    if (carToEdit) {
      ...
      const newCar: Car = {
        ...
        brand: carData.brand || 'Toyota',
        model: carData.model || '',
        year: carData.year || 2020,
        bodyType: carData.bodyType || 'SUV',
        sellingPriceLakhs: carData.sellingPriceLakhs || 1000,
        buyingPriceLakhs: carData.buyingPriceLakhs || 850,
        isPriceNegotiable: carData.isPriceNegotiable ?? true,
        color: carData.color || 'Pearl White',
        colorBurmese: carData.colorBurmese || 'ပုလဲဖြူ',
        enginePower: carData.enginePower || '2000cc',
        fuelType: carData.fuelType || 'Petrol',
        transmission: carData.transmission || 'Auto',
        mileageKm: carData.mileageKm || 45000,
        licensePlate: carData.licensePlate || '2R-1234',
        licenseCity: carData.licenseCity || 'YGN',
        grade: carData.grade || 'Grade စုံ',
        isFullOption: carData.isFullOption ?? true,
        features: carData.features || [],
        status: carData.status || 'new_arrival',
        sellerType: carData.sellerType || 'owner',
        sellerName: carData.sellerName || 'ကိုကျော်စွာ',
        sellerPhone: carData.sellerPhone || '09 798 123456',
        sellerViber: carData.sellerViber || '09798123456',
        sellerLocation: carData.sellerLocation || 'ရန်ကုန်',
        ...
        conditionNotes: carData.conditionNotes || ['စစ်ဆေးပြီး ကားသန့်'],
